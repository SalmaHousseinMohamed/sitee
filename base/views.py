...
def menu(request):
    ...
    return render(request, 'base/post_ad_categories.html', {'categories': categories, 'products': products})
...
def product_form(request, category_id):
    ...
    if request.method == 'POST':
        ...
        if form.is_valid():
            ...
            # Set the advertiser user to the currently logged-in user
            product.advertiser = request.user  # This assumes the user is logged in
    ...
    return render(request, 'base/upload.html', {'form': form, 'category': category})
...
def product_detail(request, product_id):
    ...
    advertiser = product.advertiser  # Assign advertiser here
...
def product_list(request, category_id):
    ...
    return render(request, 'base/product_list.html', {'categories': categories,'category': category, 'products': products})
